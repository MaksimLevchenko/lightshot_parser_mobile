...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m5(processed, total) => "${processed} из ${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "galleryFilterAll": MessageLookupByLibrary.simpleMessage("Все"),
    "imageDeleted": MessageLookupByLibrary.simpleMessage("Изображение удалено"),
    "imageSavedToPath": m3,
    ...
    "photoViewer": MessageLookupByLibrary.simpleMessage("Просмотр изображений"),
    ...
    "settingsAiRecognitionDescription": MessageLookupByLibrary.simpleMessage(
      "Автоматически анализировать новые загруженные изображения с помощью ONNX-моделей.",
    ),
    "settingsAiRecognitionTitle": MessageLookupByLibrary.simpleMessage(
      "Использовать AI-распознавание",
    ),
    ...
    "startingAddress": MessageLookupByLibrary.simpleMessage("Начальный адрес"),
